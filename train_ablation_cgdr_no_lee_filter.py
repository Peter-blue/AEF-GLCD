...
VARIANT_DEFAULTS = [
    ...
    ("--sar_scatter_start_epoch", "-1"),
    ("--cgdr_use_speckle_filter", "False"),
    ("--lee_filter_sar_cd", "False"),
    ("--sar_lee_filter_mode", "none"),
    ("--opt_lee_filter_mode", "none"),
...
if __name__ == "__main__":
    ...
    print("[Ablation] Baseline + HuiYan + CGDR without Lee filtering")
